...
public class ThermalIntent {
    public static final String ACTION_THERMAL_SERVICE = "light.co.thermalmonitor.ThermalService";
    ...
    public static final String PACKAGE_THERMAL_SERVICE = "light.co.thermalmonitor";
